...
import argument
import time
from utils import get_stats, write_summary, write_summary_total, write_summary_total2
...
def experiment():
    ...
    write_summary_total2(args, config_str, [roc_mean, roc_std, ap_mean, ap_std, f1_mean, f1_std, accs_mean, accs_std])
