...
if __name__ == "__main__":
    # df = pd.read_csv(f'data/raw/ZhangDDI_train_toy.csv', sep=",")
    # processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    # torch.save(processed_data, "./data/processed/ZhangDDI_train_toy2.pt")

    df = pd.read_csv(f'./data/raw/ZhangDDI_train.csv', sep=",")
    processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    torch.save(processed_data, "./data/processed/ZhangDDI_train.pt")

    df = pd.read_csv(f'./data/raw/ZhangDDI_valid.csv', sep=",")
    processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    torch.save(processed_data, "./data/processed/ZhangDDI_valid.pt")

    df = pd.read_csv(f'./data/raw/ZhangDDI_test.csv', sep=",")
    processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    torch.save(processed_data, "./data/processed/ZhangDDI_test.pt")

    # df = pd.read_csv(f'./data/raw/chemDDI_train.csv', sep=",")
    # processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    # torch.save(processed_data, "./data/processed/chemDDI_train.pt")
    #
    # df = pd.read_csv(f'./data/raw/chemDDI_valid.csv', sep=",")
    # processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    # torch.save(processed_data, "./data/processed/chemDDI_valid.pt")
    #
    # df = pd.read_csv(f'./data/raw/chemDDI_test.csv', sep=",")
    # processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    # torch.save(processed_data, "./data/processed/chemDDI_test.pt")